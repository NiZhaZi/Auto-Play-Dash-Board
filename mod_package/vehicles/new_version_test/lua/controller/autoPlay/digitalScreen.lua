...
local function normalizeUnitSystem(value)
    value = string.lower(tostring(value or "metric"))
    if value == "imperial" or value == "auto" then
        return value
    end
    return "metric"
end
...
local function updateGFX(dt)
    ...
    electrics.values.autoPlayUnitSystem = unitSystem
...
local function init(jbeamData)
    ...
    unitSystem = normalizeUnitSystem(jbeamData.unitSystem)
    electrics.values.autoPlayUnitSystem = unitSystem
